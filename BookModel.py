...
# run the command manually from python cmd
#-from BookModel import db
#-db.create_all()
#-exit()
# new database.db should be created
#cat database.db
...
# test it from python cmd
#-from BookModel import *
#-Book.add_book("Green Arrow", 9.99, 1234424)
#-Book.get_all_books()
#-exit()
...
# return json representation for our method responses
    def json(self):
